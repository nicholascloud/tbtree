  ...
  'TV Shows': {
    'Science Fiction': {
      'Battlestar Galactica': {
        ...
        episodes: {
          'Season 1': [
            '33', 'Water', 'Bastille Day', 'Act of Contrition', 'You Can\t Go Home Again', 'Litmus'
          ]
        }
      },
      ...
      'Farscape': {
        ...
        episodes: {
          'Season 1': [
            'Premiere', 'Exodus from Genesis', 'Back and Back and Back to the Future', 'Throne for a Loss', 'PK Tech Girl', 'Thank God It\s Friday Again'
          ]
        }
      }
    }
